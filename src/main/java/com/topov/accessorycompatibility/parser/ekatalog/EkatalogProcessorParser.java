...
public class EkatalogProcessorParser implements ProcessorParser {
    private static final Logger LOG = LogManager.getLogger(EkatalogProcessorParser.class.getName());
